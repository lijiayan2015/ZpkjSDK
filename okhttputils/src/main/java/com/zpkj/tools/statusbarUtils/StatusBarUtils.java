...
public class StatusBarUtils {
    /**
     * @param alpha activity背景透明度
     */
    public static void setWindowBackground(float alpha, Activity mActivity) {
  ...
  /*  *//**
    ...
    @TargetApi(19)
    public static void initSystemBar(Activity activity, int colorRes) {
        setStatusBarColor(activity, activity.getResources().getColor(colorRes), false);
        //设置状态栏字体颜色,只针对部分手机
     ...
     */
    @TargetApi(19)
    public static void initSystemBar(Activity activity, int color, int i) {
